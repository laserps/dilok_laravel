          ...
          <!-- บังคับ first child มัclass first    last child มี class last  -->
              ...
              @if(!empty($products2_highlight->result->items->item[$key_product]->priceInfo->regularPrice))
                @if($value_product->id == $products2_highlight->result->items->item[$key_product]->id)
                  @php $price_defult = $products2_highlight->result->items->item[$key_product]->priceInfo->regularPrice; @endphp
                @else
              ...
              @if(!empty($products2_highlight->result->items->item[$key_product]->priceInfo->finalPrice))
                @if($value_product->id == $products2_highlight->result->items->item[$key_product]->id)
                  @php $price_special = $products2_highlight->result->items->item[$key_product]->priceInfo->finalPrice; @endphp
                @else
