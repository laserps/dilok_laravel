    ...
    <div class="col-xl-2 col-lg-3 fillter-d-n3" id="myDIV">
      ...
      <div class="filtered-item filtered-item3 col-xl-10 col-lg-9 col-md-12 fadeIn animated">
            <div class="row mt-5 mx-0">
                <div class="col-lg-3 col-12 d-md-block d-lg-none d-xl-none fillter-r-l filter-m-l">
                ...
                <div class="col-xl-10 col-lg-9 col-12">
                    <div class="row filter-pt-3 filter-p3 mx-0">
                        ...
                        <div class="col-xl-10 col-7 col-lg-9 col-md-10 text-left text-lg-right text-md-right mt-2 order-1 order-lg-2 order-md-1">
                            <div class="fillter-font3">1-20 of 80 items</div>
                        </div>

                        <div class="col-xl-2 col-lg-3 col-md-2 col-5 text-right text-lg-right text-md-center fillter-d-n2 fillter-m-t2 order-2 order-lg-3 order-md-2 pr-0">
              ...
              @if(!empty($products->result->items->item))
                @foreach($products->result->items->item as $key_product => $value_product)
                  @foreach($value_product->customAttributes as $key_custom => $value_custom)
                    <li class=" col-lg-4 col-md-4 col-6 fadeIn animated filtered-item2 fillter-m-b filter-p">
                          ...
                          @endif
                            ...
                            <div class="card-body p-1 filter-a filter-position-a">
                              <div class="row px-0 mx-0">
                                  <div class="col-xl-10 col-lg-9 col-md-9 col-12 px-xl-2 px-0 mb-2">
                                  ...
                                  <div class="col-xl-2 col-lg-3 col-md-3 col-4 mb-2 px-0 text-right">
                                  ...
                                  <div class="d-none d-xl-block col-xl-6 col-lg-12 px-xl-1 px-lg-0 mb-xl-0 mb-2 mt-2 latest-product-btn latest-product-btn-pond fillter-btn-width">
                                  ...
                                  <div class="d-none d-xl-block col-xl-6 col-lg-12 px-xl-1 px-lg-0 mt-2 latest-product-btn latest-product-btn-pond fillter-btn-width">
                                    <a href="{{ url('product/'.$value_product->id) }}">
...
function myFunction2() {
  $('.filtered-item2').addClass('brand-collum-xxl1 col-12 col-lg-6 col-md-6');
  $('.filtered-item2').removeClass('brand-collum-xxl2 col-6 col-lg-4 col-md-4');
    if(document.getElementById("demo").innerHTML == 'show filter') {
...
function myFunction3() {
  $('.filtered-item2').addClass('brand-collum-xxl2 col-6 col-lg-4 col-md-4');
  $('.filtered-item2').removeClass('brand-collum-xxl1 col-12 col-lg-6 col-md-6');
    if(document.getElementById("demo").innerHTML == 'show filter') {
